...
#define GTK_VWRAP_BOX_GET_CLASS(obj)  (GTK_VWRAP_BOX_CLASS (GTK_OBJECT_GET_CLASS (obj)))


/* --- typedefs --- */
typedef struct GtkVWrapBox      GtkVWrapBox;
typedef struct GtkVWrapBoxClass GtkVWrapBoxClass;
