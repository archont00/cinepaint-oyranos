 ...
 *        See the source file SLIB.C for more information.                  *
 ...
 $Id: siodp.h,v 1.1 2004/02/10 00:38:57 robinrowe Exp $
...
LISP popen_c (char *name, char *how);
LISP popen_cg (FILE * (*)(const char *, const char *), char *, char *);
LISP popen_l (LISP name, LISP how);
LISP pclose_l (LISP p);
LISP feof_l (LISP p);
...
LISP lstrindx (LISP str, LISP indx);
