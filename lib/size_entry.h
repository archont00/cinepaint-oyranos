...
typedef struct GimpSizeEntry       GimpSizeEntry;
typedef struct GimpSizeEntryClass  GimpSizeEntryClass;
...
typedef struct GimpSizeEntryField  GimpSizeEntryField;
...
DLL_API GtkType     gimp_size_entry_get_type (void);

DLL_API GtkWidget * gimp_size_entry_new (gint                       number_of_fields,
				 GimpUnit                   unit,
...
gdouble     gimp_size_entry_get_refval            (GimpSizeEntry *gse,
					           gint           field);
DLL_API void        gimp_size_entry_set_refval            (GimpSizeEntry *gse,
					           gint           field,
					           gdouble        refval);
